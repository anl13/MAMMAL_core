...
std::vector<Camera> readCameras()
{
	...
	std::string m_camDir = "D:/Projects/animal_calibration/calib_batch3/result_batch3/refined_result/";
...
std::vector<cv::Mat> readImgs()
{
	...
	std::string m_imgDir = "D:/Projects/animal_calibration/calib_batch3/result_batch3/undist3/bg";
	std::vector<int> m_camids = {
		1,2,5,6,7,8,9
	};
	int m_camNum = m_camids.size();
...
void show_scene()
{
	...
	std::string point_file = "D:/Projects/animal_calibration/calib_batch3/result_batch3/refined_result/points3d.txt"; 
...
//#endif 
	...
	for (int i = 0; i < cams.size(); i++)
	{
		...
		ss_out << "D:/Projects/animal_calibration/calib_batch3/result_batch3/undist3/bg" << camids[i] << "_overlay.png"; 
